#!/usr/bin/env python3
"""Verify that Postgres data persists across Railway deploys.
...
The script:
  ...
  4. Fetches /v1/me and confirms the user record still exists (device_id,
     plan, daily_count) — proving the deploy is pointed at the same
     persistent Postgres instance, not an ephemeral one that reset.
"""
