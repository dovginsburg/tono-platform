...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-tono-bg text-tono-text font-sans antialiased">
          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-14 items-center">
            <div>
              ...
              >
                ...
                <li>account and purchase authorization required</li>
                <li aria-hidden="true" className="text-tono-text-softer/60">·</li>
              ...
              <p className="text-xs text-tono-muted mt-4">
                eligible new users start a 7-day trial after Stripe authorization. then auto-renews unless canceled.
              </p>
            </div>
      ...
      {/* ── Pricing — trial terms and subscription choices ──────────── */}
        ...
        <div className="max-w-[1080px] mx-auto px-6 md:px-10 py-20 md:py-24">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <article className="bg-tono-bg-card border border-tono-border rounded-[18px] p-7 flex flex-col">
              <p className="text-[11px] uppercase tracking-wider font-semibold text-tono-text-softer">introductory trial</p>
              <p className="text-[36px] md:text-[40px] font-bold tracking-[-0.02em] text-tono-text mt-2">
                7 days
                <span className="text-[15px] font-normal text-tono-text-softer ml-2">after authorization</span>
              </p>
              <p className="text-[14px] text-tono-text-soft leading-[1.55] mt-3">
                full Coach access through the subscription you select.
              </p>
              <ul className="mt-6 space-y-2.5 text-[14px] text-tono-text-soft">
                <li className="flex gap-2"><span className="text-tono-tone-safer font-semibold">✓</span><span><strong className="text-tono-text font-semibold">both plans include 7 days</strong> — eligibility confirmed at checkout</span></li>
                <li className="flex gap-2"><span className="text-tono-tone-safer font-semibold">✓</span><span>no access begins before Stripe authorization</span></li>
      ...
      <section className="border-t border-tono-border bg-tono-bg-soft">
        <div className="max-w-[860px] mx-auto px-6 md:px-10 py-16 md:py-20 text-center">
          ...
          <div className="mt-5 space-y-3 text-[15px] md:text-[16px] text-tono-text-soft leading-[1.65] max-w-2xl mx-auto">
            <p>
              Coach sends the draft to Tono's backend for transient analysis only after verified trial, subscription, or promo access.
            </p>
            <p>
              drafts are discarded after analysis, and nothing about your writing is used to train anything.
            </p>
          </div>
          <ul className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-[12px] uppercase tracking-[0.14em] font-semibold text-tono-text-softer">
            <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-tono-tone-safer" aria-hidden="true" />explicit authorization</li>
      ...
      <section className="border-t border-tono-border">
        <div className="max-w-[860px] mx-auto px-6 md:px-10 py-20 md:py-24 text-center">
          ...
          <p className="text-[16px] text-tono-text-soft leading-[1.6] mt-4 max-w-xl mx-auto">
            sign in, choose a plan, and authorize an eligible 7-day trial. auto-renews unless cancelled.
          </p>
