...
final class Build115LocalCoachTests: XCTestCase {
    ...
    ///
    /// BUILD 126 RELEASE-IDENTITY UPDATE — this assertion tracks the prepared
    /// release. The suite's Build 115/117 behavior evidence remains historical.
    func testAllFourShippedBundlesArePreparedBuild126() throws {
        ...
        XCTAssertEqual(expected, "126", "the build guard must pin the reviewed number")
