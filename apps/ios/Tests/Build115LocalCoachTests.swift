...
final class Build115LocalCoachTests: XCTestCase {
    ...
    ///
    /// BUILD 127 RELEASE-IDENTITY UPDATE — this assertion tracks the prepared
    /// release (App Review rejection successor above live ASC build 126). The
    /// suite's Build 115/117 behavior evidence remains historical.
    func testAllFourShippedBundlesArePreparedBuild127() throws {
        ...
        XCTAssertEqual(expected, "127", "the build guard must pin the reviewed number")
